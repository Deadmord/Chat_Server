...
void MediaSaver_Service::savedMedia(const QUuid &id_, const quint32 &room_id_, const QString &login_, bool success_) {

}

QByteArray MediaSaver_Service::getMedia(const QUuid &media_id_, const quint32 &room_id_) {
